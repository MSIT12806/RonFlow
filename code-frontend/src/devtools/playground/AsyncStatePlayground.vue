...
const playgroundBoardColumns: BoardColumnResponse[] = [
  {
    ...
    tasks: [
      { id: 'task-1', title: '整理 Sprint 2 測試清單', isCompleted: false, isInFlow: true, isSplitComplete: false, completedAt: null, parentPath: '整理 Hatchery 需求', children: [] },
      { id: 'task-2', title: '確認拖曳失敗的回饋文案', isCompleted: false, isInFlow: true, isSplitComplete: false, completedAt: null, parentPath: '', children: [] },
    ],
  },
  {
    stateKey: 'active',
    ...
    isCompletedState: false,
    emptyStateMessage: '目前沒有任務',
    tasks: [{ id: 'task-3', title: '補上 board command error alert', isCompleted: false, isInFlow: true, isSplitComplete: false, completedAt: null, parentPath: '整理 Hatchery 需求', children: [] }],
  },
  {
    stateKey: 'review',
    label: '審查中',
  ...
  },
  {
    ...
    emptyStateMessage: '目前沒有任務',
    tasks: [{ id: 'task-4', title: '完成 v0.1 scope 對齊', isCompleted: true, isInFlow: true, isSplitComplete: false, completedAt: '2026-05-11T09:00:00.000Z', parentPath: '', children: [] }],
  },
]
...
const playgroundTaskTree = [
  {
    ...
    parentPath: '',
    children: [
      { id: 'task-tree-1-1', title: '撰寫 SRS', isCompleted: true, isInFlow: true, isSplitComplete: false, completedAt: '2026-05-10T08:00:00.000Z', parentPath: '整理 Hatchery 需求', children: [] },
      { id: 'task-tree-1-2', title: '拆解 MVP backlog', isCompleted: false, isInFlow: false, isSplitComplete: false, completedAt: null, parentPath: '整理 Hatchery 需求', children: [] },
    ],
  },
]
