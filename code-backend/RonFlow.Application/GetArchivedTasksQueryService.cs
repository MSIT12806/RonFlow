...
public sealed class GetArchivedTasksQueryService(ProjectAccessService projectAccessService, ITaskRepository taskRepository)
{
    public OwnedResourceQueryResult<LifecycleTaskListView> Get(Guid currentUserId, Guid projectId)
    {
        ...
        return OwnedResourceQueryResult<LifecycleTaskListView>.Success(
            CoreFlowReadModelFactory.CreateLifecycleTaskList(access.Project!, tasks, TaskLifecycleState.Archived));
    }
}